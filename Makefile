# This Makefile is for the Dancer::CommandLine extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Dancer/CommandLine.pm]
#     AUTHOR => q[Maurice Mengel <mauricemengel@gmail.com>]
#     BUILD_REQUIRES => {  }
#     LICENSE => q[perl]
#     NAME => q[Dancer::CommandLine]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Dancer/CommandLine.pm]
#     clean => { FILES=>q[Dancer-CommandLine-*] }
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Dancer::CommandLine
NAME_SYM = Dancer_CommandLine
VERSION = 0.01
...
PERL_LIB = /usr/lib/perl5/5.10
PERL_ARCHLIB = /usr/lib/perl5/5.10/i686-cygwin
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /usr/lib/perl5/5.10/i686-cygwin/CORE
...
MAKEMAKER   = /usr/lib/perl5/5.10/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.55_02
MM_REVISION = 65502
...
MAKE = make
FULLEXT = Dancer/CommandLine
BASEEXT = CommandLine
PARENT_NAME = Dancer
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Dancer/CommandLine.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Dancer
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Dancer
...
# Extra linker info
EXPORT_LIST        = 
PERL_ARCHIVE       = $(PERL_INC)/cygperl5_10.dll
PERL_ARCHIVE_AFTER = 
...
DISTNAME = Dancer-CommandLine
DISTVNAME = Dancer-CommandLine-0.01
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Dancer-CommandLine' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:            0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:           Warning and Debug for Dancer and non-dancing scripts' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - Maurice Mengel <mauricemengel@gmail.com>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Warning and Debug for Dancer and non-dancing scripts</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Maurice Mengel &lt;mauricemengel@gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::More" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <ARCHITECTURE NAME="i686-cygwin-thread-multi-64int-5.10" />' >> $(DISTNAME).ppd
